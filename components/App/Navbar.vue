...
const MENU_ITEMS = [
  { text: 'Publications', to: '/articles/', activeRoutes: [] },
  { text: 'Events', to: '/speaking/', activeRoutes: [] },
  { text: 'Career Goals', to: '/services/', activeRoutes: ['/workshops/', '/consulting/'] },
      ...
      <div class="flex h-20 items-center justify-between">
        <div class="flex items-center mr-3">
          <AppLink to="/" class="flex-shrink-0 flex items-center">
            <img width="64" height="76" class="mr-4" src="/img/header_bulb.png"
              alt="Alexander Lichter Lightbulb" />
            <img width="147" height="80" src="/img/header_logo.png" alt="Alexander Lichter Lightbulb" />
          </AppLink>
        </div>
